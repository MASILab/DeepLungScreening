...
def copy_cohort(src_dir, dst_dir, cohort_path):
    ...
    cohort_df = cohort_df[~cohort_df['id'].isnull()]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_dir', type=str, default='/nfs/masi/MCL/nifti/combine')
    parser.add_argument('--dst_dir', type=str, default='/home/local/VANDERBILT/litz/data/multi_mcl/DeepLungScreening/nifti')
    parser.add_argument('--cohort_df', type=str, default='/home/local/VANDERBILT/litz/github/MASILab/DeepLungScreening/cohorts/multi_mcl_v1.csv')
