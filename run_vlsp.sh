#!/bin/bash
ROOT=/home/local/VANDERBILT/litz/data/vlsp/DeepLungScreening
ORI_ROOT=${ROOT}/nifti
PREP_ROOT=${ROOT}/prep
BBOX_ROOT=${ROOT}/bbox
FEAT_ROOT=${ROOT}/feat
PRED_CSV=${ROOT}/pred/vlsp_pred_v1.csv
SPLIT_CSV=/home/local/VANDERBILT/litz/github/MASILab/DeepLungScreening/cohorts/vlsp_cohort_v1.csv
