#!/bin/bash
ROOT=/home/local/VANDERBILT/litz/data/bronch/DeepLungScreening
ORI_ROOT=${ROOT}/nifti
PREP_ROOT=${ROOT}/prep
BBOX_ROOT=${ROOT}/bbox
FEAT_ROOT=${ROOT}/feat
PRED_CSV=${ROOT}/pred/bronch_pred_v1.csv
ALL_SCANS=/home/local/VANDERBILT/litz/github/MASILab/DeepLungScreening/cohorts/bronch/bronch_v1.csv
SPLIT_CSV=/home/local/VANDERBILT/litz/github/MASILab/DeepLungScreening/cohorts/bronch/bronch_v1.csv

echo "Run step 1 data preprocessing ..."

python3 ./1_preprocess/step1_main.py --sess_csv ${ALL_SCANS} --prep_root ${PREP_ROOT} --ori_root ${ORI_ROOT}
